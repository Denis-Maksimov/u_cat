...
void add_rule (int8_t fuzzy_error, op_type operand, int8_t fuzzy_delta_E, int8_t output){
    rules[num_of_rulez].fe=fuzzy_error;
    rules[num_of_rulez].op=operand;
    rules[num_of_rulez].fde=fuzzy_delta_E;
    rules[num_of_rulez].z=output;
    num_of_rulez++;
}
